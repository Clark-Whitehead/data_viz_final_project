        ...
        dbc.Row([
            dbc.Col(
                html.Section([
                    ...
                    html.H4(
                        'Data Visualization - Final Project, Fall 2021 - Clark Whitehead',
                    ...
                    dbc.Row([
                        ...
                        dbc.Col(html.H5(
                            dcc.Link(
                                'GitHub Repository',
                                href='https://github.com/Clark-Whitehead/data_viz_final_project',
                        ...
                        dbc.Col(html.H5(
                            dcc.Link(
                                ...
                                href='https://github.com/Clark-Whitehead/data_viz_final_project/blob/main/final.ipynb',
                                style = dict(color = disney_dark_blue_hex),
                                target = "_blank"
                            ), style = dict(color = disney_dark_blue_hex),
                        ), width = 5),
